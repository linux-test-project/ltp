/*
   b_mqd.h   Generated by the Ballista(tm) Project data object compiler
...
#include "bTypes.h"
 ...
 #include <mqueue.h>
 #include <fcntl.h>
 #define CLASSTYPE mqd_t
#define CLASSNAME b_mqd
#define CLASS_STRING "b_mqd"
...
private:
  ...
  b_param _b_mqdTYPENAME;
b_param _b_mqdOPEN_QUEUE;
int b_mqd_open_queue;
b_param _b_mqdCLOSE_QUEUE;
int b_mqd_close_queue;
b_param _b_mqdUNLINK_QUEUE;
int b_mqd_unlink_queue;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_mqdOPEN_QUEUE();
b_param *b_mqdCLOSE_QUEUE();
b_param *b_mqdUNLINK_QUEUE();
  //CLASS CONSTRUCTOR
  CLASSNAME();
