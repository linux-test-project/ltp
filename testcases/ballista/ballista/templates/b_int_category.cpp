/*
   b_int_category.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_int_categoryTYPENAME,CLASS_STRING);
strcpy(_b_int_categoryLC_ALL,"b_int_category_LC_ALL");
strcpy(_b_int_categoryLC_NUMERIC,"b_int_category_LC_NUMERIC");
}

//--------------------------------------------------------------------
b_param *b_int_category::b_int_categoryLC_ALL()
{
   return &_b_int_categoryLC_ALL;
}

b_param *b_int_category::b_int_categoryLC_NUMERIC()
{
   return &_b_int_categoryLC_NUMERIC;
}
...
{
  return &_b_int_categoryTYPENAME;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_int_category_lc_all = 0;
b_int_category_lc_numeric = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_int_categoryLC_ALL)==0)
      b_int_category_lc_all = 1;
   else if (strcmp(data[dataPTR],_b_int_categoryLC_NUMERIC)==0)
      b_int_category_lc_numeric = 1;
  else
    {
...
if (b_int_category_lc_numeric==1)
{
...
case 1:
 switch (position)
   {
      case 1:
         return b_int_categoryLC_ALL();
         break;
      case 2:
         return b_int_categoryLC_NUMERIC();
         break;
