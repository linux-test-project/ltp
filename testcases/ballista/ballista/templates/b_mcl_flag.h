/*
   b_mcl_flag.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSNAME b_mcl_flag
#define CLASS_STRING "b_mcl_flag"
...
private:
  ...
  b_param _b_mcl_flagTYPENAME;
b_param _b_mcl_flagCURRENT;
int b_mcl_flag_current;
b_param _b_mcl_flagFUTURE;
int b_mcl_flag_future;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_mcl_flagCURRENT();
b_param *b_mcl_flagFUTURE();
  //CLASS CONSTRUCTOR
  CLASSNAME();
