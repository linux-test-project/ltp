/*
   b_ptr_void.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSNAME b_ptr_void
#define CLASS_STRING "b_ptr_void"
...
private:
  ...
  b_param _b_ptr_voidTYPENAME;
b_param _b_ptr_voidNULL;
int b_ptr_void_null;
b_param _b_ptr_voidNEGONE;
int b_ptr_void_negone;
b_param _b_ptr_voidMAXINT;
int b_ptr_void_maxint;
b_param _b_ptr_voidSTATIC;
int b_ptr_void_static;
b_param _b_ptr_voidDYNAMIC;
int b_ptr_void_dynamic;
b_param _b_ptr_voidCONST;
int b_ptr_void_const;
b_param _b_ptr_voidFREED;
int b_ptr_void_freed;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_ptr_voidNULL();
b_param *b_ptr_voidNEGONE();
b_param *b_ptr_voidMAXINT();
b_param *b_ptr_voidSTATIC();
b_param *b_ptr_voidDYNAMIC();
b_param *b_ptr_voidCONST();
b_param *b_ptr_voidFREED();
  //CLASS CONSTRUCTOR
  CLASSNAME();
