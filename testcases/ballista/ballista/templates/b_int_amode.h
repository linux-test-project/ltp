/*
   b_int_amode.h   Generated by the Ballista(tm) Project data object compiler
...
//include control
#ifndef B_INT_AMODE_H
#define B_INT_AMODE_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#define CLASSNAME b_int_amode
#define CLASS_STRING "b_int_amode"
...
private:
  ...
  b_param _b_int_amodeTYPENAME;
b_param _b_int_amodeR_OK;
int b_int_amode_r_ok;
b_param _b_int_amodeF_OK;
int b_int_amode_f_ok;
b_param _b_int_amodeRWX_OK;
int b_int_amode_rwx_ok;
b_param _b_int_amodeFRWX_OK;
int b_int_amode_frwx_ok;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_int_amodeR_OK();
b_param *b_int_amodeF_OK();
b_param *b_int_amodeRWX_OK();
b_param *b_int_amodeFRWX_OK();
  //CLASS CONSTRUCTOR
  CLASSNAME();
