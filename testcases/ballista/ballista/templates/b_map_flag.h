/*
   b_map_flag.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSNAME b_map_flag
#define CLASS_STRING "b_map_flag"
...
private:
  ...
  b_param _b_map_flagTYPENAME;
b_param _b_map_flagSHARED;
int b_map_flag_shared;
b_param _b_map_flagPRIVATE;
int b_map_flag_private;
b_param _b_map_flagFIXED;
int b_map_flag_fixed;
b_param _b_map_flagALL;
int b_map_flag_all;
...
b_param *b_map_flagSHARED();
b_param *b_map_flagPRIVATE();
b_param *b_map_flagFIXED();
b_param *b_map_flagALL();
  //CLASS CONSTRUCTOR
  CLASSNAME();
