/*
   b_ptr_long.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_ptr_longTYPENAME,CLASS_STRING);
strcpy(_b_ptr_longMAXLONG,"b_ptr_long_MAXLONG");
strcpy(_b_ptr_longNEG_MAXLONG,"b_ptr_long_NEG_MAXLONG");
}

//--------------------------------------------------------------------
b_param *b_ptr_long::b_ptr_longMAXLONG()
{
   return &_b_ptr_longMAXLONG;
}

b_param *b_ptr_long::b_ptr_longNEG_MAXLONG()
{
   return &_b_ptr_longNEG_MAXLONG;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_ptr_long_maxlong = 0;
b_ptr_long_neg_maxlong = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_ptr_longMAXLONG)==0)
      b_ptr_long_maxlong = 1;
   else if (strcmp(data[dataPTR],_b_ptr_longNEG_MAXLONG)==0)
      b_ptr_long_neg_maxlong = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_ptr_longMAXLONG();
         break;
      case 2:
         return b_ptr_longNEG_MAXLONG();
         break;
