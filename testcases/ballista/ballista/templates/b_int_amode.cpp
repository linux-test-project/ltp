/*
   b_int_amode.cpp   Generated by the Ballista(tm) Project data object compiler
   ...
   File generated Saturday, December 18 at 10:19 AM CST
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_int_amodeTYPENAME,CLASS_STRING);
strcpy(_b_int_amodeR_OK,"b_int_amode_R_OK");
strcpy(_b_int_amodeF_OK,"b_int_amode_F_OK");
strcpy(_b_int_amodeRWX_OK,"b_int_amode_RWX_OK");
strcpy(_b_int_amodeFRWX_OK,"b_int_amode_FRWX_OK");
}

//--------------------------------------------------------------------
b_param *b_int_amode::b_int_amodeR_OK()
{
   return &_b_int_amodeR_OK;
}

b_param *b_int_amode::b_int_amodeF_OK()
{
   return &_b_int_amodeF_OK;
}

b_param *b_int_amode::b_int_amodeRWX_OK()
{
   return &_b_int_amodeRWX_OK;
}

b_param *b_int_amode::b_int_amodeFRWX_OK()
{
   return &_b_int_amodeFRWX_OK;
}
...
b_int_amode_r_ok = 0;
b_int_amode_f_ok = 0;
b_int_amode_rwx_ok = 0;
b_int_amode_frwx_ok = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_int_amodeR_OK)==0)
      b_int_amode_r_ok = 1;
   else if (strcmp(data[dataPTR],_b_int_amodeF_OK)==0)
      b_int_amode_f_ok = 1;
   else if (strcmp(data[dataPTR],_b_int_amodeRWX_OK)==0)
      b_int_amode_rwx_ok = 1;
   else if (strcmp(data[dataPTR],_b_int_amodeFRWX_OK)==0)
      b_int_amode_frwx_ok = 1;
  else
    {
...
if (b_int_amode_f_ok==1 || b_int_amode_frwx_ok==1)
{
...
case 1:
 switch (position)
   {
      case 1:
         return b_int_amodeR_OK();
         break;
      case 2:
         return b_int_amodeF_OK();
         break;
      case 3:
         return b_int_amodeRWX_OK();
         break;
      case 4:
         return b_int_amodeFRWX_OK();
         break;
