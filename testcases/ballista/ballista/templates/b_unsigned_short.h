/*
   b_unsigned_short.h   Generated by the Ballista(tm) Project data object compiler
...
//include control
#ifndef B_UNSIGNED_SHORT_H
#define B_UNSIGNED_SHORT_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#include "bTypes.h"
 ...
 #define CLASSTYPE Ushort
#define CLASSNAME b_unsigned_short
#define CLASS_STRING "b_unsigned_short"
#define CLASSPARENT b_short_int_common
...
private:
  ...
  b_param _b_unsigned_shortTYPENAME;
b_param _b_unsigned_shortMAXSHORTPLUS1;
int b_unsigned_short_maxshortplus1;
b_param _b_unsigned_shortMAXUSHORT;
int b_unsigned_short_maxushort;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_unsigned_shortMAXSHORTPLUS1();
b_param *b_unsigned_shortMAXUSHORT();
  //CLASS CONSTRUCTOR
  CLASSNAME();
