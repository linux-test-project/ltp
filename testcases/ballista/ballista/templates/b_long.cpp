/*
   b_long.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_longTYPENAME,CLASS_STRING);
strcpy(_b_longMAXLONG,"b_long_MAXLONG");
strcpy(_b_longNEG_MAXLONG,"b_long_NEG_MAXLONG");
}

//--------------------------------------------------------------------
b_param *b_long::b_longMAXLONG()
{
   return &_b_longMAXLONG;
}

b_param *b_long::b_longNEG_MAXLONG()
{
   return &_b_longNEG_MAXLONG;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_long_maxlong = 0;
b_long_neg_maxlong = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_longMAXLONG)==0)
      b_long_maxlong = 1;
   else if (strcmp(data[dataPTR],_b_longNEG_MAXLONG)==0)
      b_long_neg_maxlong = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_longMAXLONG();
         break;
      case 2:
         return b_longNEG_MAXLONG();
         break;
