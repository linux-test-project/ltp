/*
   b_unsigned_long.h   Generated by the Ballista(tm) Project data object compiler
...
//include control
#ifndef B_UNSIGNED_LONG_H
#define B_UNSIGNED_LONG_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#include "bTypes.h"
 ...
 #define CLASSTYPE Ulong
#define CLASSNAME b_unsigned_long
#define CLASS_STRING "b_unsigned_long"
#define CLASSPARENT b_unsigned_int
...
private:
  ...
  b_param _b_unsigned_longTYPENAME;
b_param _b_unsigned_longMAXULONG;
int b_unsigned_long_maxulong;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_unsigned_longMAXULONG();
  //CLASS CONSTRUCTOR
  CLASSNAME();
