/*
   b_ms_flag.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_ms_flagTYPENAME,CLASS_STRING);
strcpy(_b_ms_flagASYNC,"b_ms_flag_ASYNC");
strcpy(_b_ms_flagSYNC,"b_ms_flag_SYNC");
strcpy(_b_ms_flagINVALIDATE,"b_ms_flag_INVALIDATE");
strcpy(_b_ms_flagALL,"b_ms_flag_ALL");
}

//--------------------------------------------------------------------
b_param *b_ms_flag::b_ms_flagASYNC()
{
   return &_b_ms_flagASYNC;
}

b_param *b_ms_flag::b_ms_flagSYNC()
{
   return &_b_ms_flagSYNC;
}

b_param *b_ms_flag::b_ms_flagINVALIDATE()
{
   return &_b_ms_flagINVALIDATE;
}

b_param *b_ms_flag::b_ms_flagALL()
{
   return &_b_ms_flagALL;
}
...
b_ms_flag_async = 0;
b_ms_flag_sync = 0;
b_ms_flag_invalidate = 0;
b_ms_flag_all = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_ms_flagASYNC)==0)
      b_ms_flag_async = 1;
   else if (strcmp(data[dataPTR],_b_ms_flagSYNC)==0)
      b_ms_flag_sync = 1;
   else if (strcmp(data[dataPTR],_b_ms_flagINVALIDATE)==0)
      b_ms_flag_invalidate = 1;
   else if (strcmp(data[dataPTR],_b_ms_flagALL)==0)
      b_ms_flag_all = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_ms_flagASYNC();
         break;
      case 2:
         return b_ms_flagSYNC();
         break;
      case 3:
         return b_ms_flagINVALIDATE();
         break;
      case 4:
         return b_ms_flagALL();
         break;
