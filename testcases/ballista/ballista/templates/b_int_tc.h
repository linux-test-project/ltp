/*
   b_int_tc.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSNAME b_int_tc
#define CLASS_STRING "b_int_tc"
...
private:
  ...
  b_param _b_int_tcTYPENAME;
b_param _b_int_tcTCIFLUSH;
int b_int_tc_tciflush;
b_param _b_int_tcTCSANOW;
int b_int_tc_tcsanow;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_int_tcTCIFLUSH();
b_param *b_int_tcTCSANOW();
  //CLASS CONSTRUCTOR
  CLASSNAME();
