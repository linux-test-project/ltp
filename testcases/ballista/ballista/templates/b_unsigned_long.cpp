/*
   b_unsigned_long.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_unsigned_longTYPENAME,CLASS_STRING);
strcpy(_b_unsigned_longMAXULONG,"b_unsigned_long_MAXULONG");
}

//--------------------------------------------------------------------
b_param *b_unsigned_long::b_unsigned_longMAXULONG()
{
   return &_b_unsigned_longMAXULONG;
}
...
{
  return &_b_unsigned_longTYPENAME;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_unsigned_long_maxulong = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_unsigned_longMAXULONG)==0)
      b_unsigned_long_maxulong = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_unsigned_longMAXULONG();
         break;
