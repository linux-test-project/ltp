/*
   b_ptr_dir.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSTYPE DIR*
#define CLASSNAME b_ptr_dir
#define CLASS_STRING "b_ptr_dir"
...
private:
  ...
  b_param _b_ptr_dirTYPENAME;
b_param _b_ptr_dirDIR_CLOSED;
int b_ptr_dir_dir_closed;
b_param _b_ptr_dirDIR_OPEN;
int b_ptr_dir_dir_open;
b_param _b_ptr_dirDIR_REMOVED;
int b_ptr_dir_dir_removed;
b_param _b_ptr_dirDIR_MIDWAY;
int b_ptr_dir_dir_midway;
b_param _b_ptr_dirEMPTY;
int b_ptr_dir_empty;
b_param _b_ptr_dirWITH_FILES;
int b_ptr_dir_with_files;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_ptr_dirDIR_CLOSED();
b_param *b_ptr_dirDIR_OPEN();
b_param *b_ptr_dirDIR_REMOVED();
b_param *b_ptr_dirDIR_MIDWAY();
b_param *b_ptr_dirEMPTY();
b_param *b_ptr_dirWITH_FILES();
  //CLASS CONSTRUCTOR
  CLASSNAME();
