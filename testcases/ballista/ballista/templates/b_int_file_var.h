/*
   b_int_file_var.h   Generated by the Ballista(tm) Project data object compiler
...
//include control
#ifndef B_INT_FILE_VAR_H
#define B_INT_FILE_VAR_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#define CLASSNAME b_int_file_var
#define CLASS_STRING "b_int_file_var"
...
private:
  ...
  b_param _b_int_file_varTYPENAME;
b_param _b_int_file_varNAME_MAX;
int b_int_file_var_name_max;
b_param _b_int_file_varSYNC_IO;
int b_int_file_var_sync_io;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_int_file_varNAME_MAX();
b_param *b_int_file_varSYNC_IO();
  //CLASS CONSTRUCTOR
  CLASSNAME();
