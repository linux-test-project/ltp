/*
   b_pid.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSTYPE pid_t
#define CLASSNAME b_pid
#define CLASS_STRING "b_pid"
...
private:
  ...
  b_param _b_pidTYPENAME;
b_param _b_pidPID_SELF;
int b_pid_pid_self;
b_param _b_pidPID_CHILD;
int b_pid_pid_child;
b_param _b_pidPID_65535;
int b_pid_pid_65535;
b_param _b_pidPID_65536;
int b_pid_pid_65536;
...
b_param *b_pidPID_SELF();
b_param *b_pidPID_CHILD();
b_param *b_pidPID_65535();
b_param *b_pidPID_65536();
  //CLASS CONSTRUCTOR
  CLASSNAME();
