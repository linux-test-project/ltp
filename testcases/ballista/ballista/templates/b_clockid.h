/*
   b_clockid.h   Generated by the Ballista(tm) Project data object compiler
...
#include "bTypes.h"
 ...
 #include "b_int.h"
 #include <time.h>
 #define CLASSTYPE clockid_t
#define CLASSNAME b_clockid
#define CLASS_STRING "b_clockid"
