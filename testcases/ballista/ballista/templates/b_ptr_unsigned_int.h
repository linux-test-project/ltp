/*
   b_ptr_unsigned_int.h   Generated by the Ballista(tm) Project data object compiler
...
TITLE
   b_ptr_unsigned_int.h
*/

//include control
#ifndef B_PTR_UNSIGNED_INT_H
#define B_PTR_UNSIGNED_INT_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#define CLASSTYPE uintPtr
#define CLASSNAME b_ptr_unsigned_int
#define CLASS_STRING "b_ptr_unsigned_int"
...
private:
  ...
  b_param _b_ptr_unsigned_intTYPENAME;
b_param _b_ptr_unsigned_intMAXUINT;
int b_ptr_unsigned_int_maxuint;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_ptr_unsigned_intMAXUINT();
  //CLASS CONSTRUCTOR
  CLASSNAME();
