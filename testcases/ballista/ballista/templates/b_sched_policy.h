/*
   b_sched_policy.h   Generated by the Ballista(tm) Project data object compiler
...
//include control
#ifndef B_SCHED_POLICY_H
#define B_SCHED_POLICY_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#define CLASSNAME b_sched_policy
#define CLASS_STRING "b_sched_policy"
...
private:
  ...
  b_param _b_sched_policyTYPENAME;
b_param _b_sched_policyFIFO;
int b_sched_policy_fifo;
b_param _b_sched_policyRR;
int b_sched_policy_rr;
b_param _b_sched_policyOTHER;
int b_sched_policy_other;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_sched_policyFIFO();
b_param *b_sched_policyRR();
b_param *b_sched_policyOTHER();
  //CLASS CONSTRUCTOR
  CLASSNAME();
