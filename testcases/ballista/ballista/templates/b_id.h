/*
   b_id.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSTYPE uid_t
#define CLASSNAME b_id
#define CLASS_STRING "b_id"
...
private:
  ...
  b_param _b_idTYPENAME;
b_param _b_idUID_SELF;
int b_id_uid_self;
b_param _b_idGID_SELF;
int b_id_gid_self;
b_param _b_idEUID_SELF;
int b_id_euid_self;
b_param _b_idEGID_SELF;
int b_id_egid_self;
b_param _b_idUID_PLUS1;
int b_id_uid_plus1;
b_param _b_idGID_PLUS1;
int b_id_gid_plus1;
...
b_param *b_idUID_SELF();
b_param *b_idGID_SELF();
b_param *b_idEUID_SELF();
b_param *b_idEGID_SELF();
b_param *b_idUID_PLUS1();
b_param *b_idGID_PLUS1();
  //CLASS CONSTRUCTOR
  CLASSNAME();
