/*
   b_clockid.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_clockidTYPENAME,CLASS_STRING);
strcpy(_b_clockidREALTIME,"b_clockid_REALTIME");
}

//--------------------------------------------------------------------
b_param *b_clockid::b_clockidREALTIME()
{
   return &_b_clockidREALTIME;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_clockid_realtime = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_clockidREALTIME)==0)
      b_clockid_realtime = 1;
  else
    {
