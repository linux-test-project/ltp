/*
   b_prot_flag.h   Generated by the Ballista(tm) Project data object compiler
...
//include control
#ifndef B_PROT_FLAG_H
#define B_PROT_FLAG_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#define CLASSNAME b_prot_flag
#define CLASS_STRING "b_prot_flag"
...
private:
  ...
  b_param _b_prot_flagTYPENAME;
b_param _b_prot_flagREAD;
int b_prot_flag_read;
b_param _b_prot_flagWRITE;
int b_prot_flag_write;
b_param _b_prot_flagEXEC;
int b_prot_flag_exec;
b_param _b_prot_flagALL;
int b_prot_flag_all;
b_param _b_prot_flagNONE;
int b_prot_flag_none;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_prot_flagREAD();
b_param *b_prot_flagWRITE();
b_param *b_prot_flagEXEC();
b_param *b_prot_flagALL();
b_param *b_prot_flagNONE();
  //CLASS CONSTRUCTOR
  CLASSNAME();
