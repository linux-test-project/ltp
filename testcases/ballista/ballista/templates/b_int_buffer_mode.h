/*
   b_int_buffer_mode.h   Generated by the Ballista(tm) Project data object compiler
...
//include control
#ifndef B_INT_BUFFER_MODE_H
#define B_INT_BUFFER_MODE_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#define CLASSNAME b_int_buffer_mode
#define CLASS_STRING "b_int_buffer_mode"
...
private:
  ...
  b_param _b_int_buffer_modeTYPENAME;
b_param _b_int_buffer_modeIOFBF;
int b_int_buffer_mode_iofbf;
b_param _b_int_buffer_modeIONBF;
int b_int_buffer_mode_ionbf;
b_param _b_int_buffer_modeIOLBF;
int b_int_buffer_mode_iolbf;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_int_buffer_modeIOFBF();
b_param *b_int_buffer_modeIONBF();
b_param *b_int_buffer_modeIOLBF();
  //CLASS CONSTRUCTOR
  CLASSNAME();
