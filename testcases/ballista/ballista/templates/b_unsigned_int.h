/*
   b_unsigned_int.h   Generated by the Ballista(tm) Project data object compiler
...
//include control
#ifndef B_UNSIGNED_INT_H
#define B_UNSIGNED_INT_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#include "bTypes.h"
 ...
 #define CLASSTYPE Uint
#define CLASSNAME b_unsigned_int
#define CLASS_STRING "b_unsigned_int"
#define CLASSPARENT b_unsigned_short
...
private:
  ...
  b_param _b_unsigned_intTYPENAME;
b_param _b_unsigned_intMAXUINT;
int b_unsigned_int_maxuint;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_unsigned_intMAXUINT();
  //CLASS CONSTRUCTOR
  CLASSNAME();
