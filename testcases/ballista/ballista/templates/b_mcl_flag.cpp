/*
   b_mcl_flag.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_mcl_flagTYPENAME,CLASS_STRING);
strcpy(_b_mcl_flagCURRENT,"b_mcl_flag_CURRENT");
strcpy(_b_mcl_flagFUTURE,"b_mcl_flag_FUTURE");
}

//--------------------------------------------------------------------
b_param *b_mcl_flag::b_mcl_flagCURRENT()
{
   return &_b_mcl_flagCURRENT;
}

b_param *b_mcl_flag::b_mcl_flagFUTURE()
{
   return &_b_mcl_flagFUTURE;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_mcl_flag_current = 0;
b_mcl_flag_future = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_mcl_flagCURRENT)==0)
      b_mcl_flag_current = 1;
   else if (strcmp(data[dataPTR],_b_mcl_flagFUTURE)==0)
      b_mcl_flag_future = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_mcl_flagCURRENT();
         break;
      case 2:
         return b_mcl_flagFUTURE();
         break;
