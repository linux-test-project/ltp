/*
   b_wchar.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_wcharTYPENAME,CLASS_STRING);
strcpy(_b_wcharWCHAR_MAX,"b_wchar_WCHAR_MAX");
strcpy(_b_wcharWCHAR_MIN,"b_wchar_WCHAR_MIN");
strcpy(_b_wcharWCHAR_SPACE,"b_wchar_WCHAR_SPACE");
}

//--------------------------------------------------------------------
b_param *b_wchar::b_wcharWCHAR_MAX()
{
   return &_b_wcharWCHAR_MAX;
}

b_param *b_wchar::b_wcharWCHAR_MIN()
{
   return &_b_wcharWCHAR_MIN;
}

b_param *b_wchar::b_wcharWCHAR_SPACE()
{
   return &_b_wcharWCHAR_SPACE;
}
...
b_wchar_wchar_max = 0;
b_wchar_wchar_min = 0;
b_wchar_wchar_space = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_wcharWCHAR_MAX)==0)
      b_wchar_wchar_max = 1;
   else if (strcmp(data[dataPTR],_b_wcharWCHAR_MIN)==0)
      b_wchar_wchar_min = 1;
   else if (strcmp(data[dataPTR],_b_wcharWCHAR_SPACE)==0)
      b_wchar_wchar_space = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_wcharWCHAR_MAX();
         break;
      case 2:
         return b_wcharWCHAR_MIN();
         break;
      case 3:
         return b_wcharWCHAR_SPACE();
         break;
