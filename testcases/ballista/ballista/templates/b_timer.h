/*
   b_timer.h   Generated by the Ballista(tm) Project data object compiler
...
#include "bTypes.h"
 ...
 #include "b_int.h"
 #include <time.h>
 #define CLASSTYPE timer_t
#define CLASSNAME b_timer
#define CLASS_STRING "b_timer"
...
private:
  ...
  b_param _b_timerTYPENAME;
b_param _b_timerABS;
int b_timer_abs;
b_param _b_timerLOCAL;
int b_timer_local;
