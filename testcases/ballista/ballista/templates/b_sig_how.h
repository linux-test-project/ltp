/*
   b_sig_how.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSNAME b_sig_how
#define CLASS_STRING "b_sig_how"
...
private:
  ...
  b_param _b_sig_howTYPENAME;
b_param _b_sig_howSIGBLOCK;
int b_sig_how_sigblock;
b_param _b_sig_howSIGUNBLOCK;
int b_sig_how_sigunblock;
b_param _b_sig_howSIGSETMASK;
int b_sig_how_sigsetmask;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_sig_howSIGBLOCK();
b_param *b_sig_howSIGUNBLOCK();
b_param *b_sig_howSIGSETMASK();
  //CLASS CONSTRUCTOR
  CLASSNAME();
