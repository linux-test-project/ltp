/*
   b_sig_how.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_sig_howTYPENAME,CLASS_STRING);
strcpy(_b_sig_howSIGBLOCK,"b_sig_how_SIGBLOCK");
strcpy(_b_sig_howSIGUNBLOCK,"b_sig_how_SIGUNBLOCK");
strcpy(_b_sig_howSIGSETMASK,"b_sig_how_SIGSETMASK");
}

//--------------------------------------------------------------------
b_param *b_sig_how::b_sig_howSIGBLOCK()
{
   return &_b_sig_howSIGBLOCK;
}

b_param *b_sig_how::b_sig_howSIGUNBLOCK()
{
   return &_b_sig_howSIGUNBLOCK;
}

b_param *b_sig_how::b_sig_howSIGSETMASK()
{
   return &_b_sig_howSIGSETMASK;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_sig_how_sigblock = 0;
b_sig_how_sigunblock = 0;
b_sig_how_sigsetmask = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_sig_howSIGBLOCK)==0)
      b_sig_how_sigblock = 1;
   else if (strcmp(data[dataPTR],_b_sig_howSIGUNBLOCK)==0)
      b_sig_how_sigunblock = 1;
   else if (strcmp(data[dataPTR],_b_sig_howSIGSETMASK)==0)
      b_sig_how_sigsetmask = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_sig_howSIGBLOCK();
         break;
      case 2:
         return b_sig_howSIGUNBLOCK();
         break;
      case 3:
         return b_sig_howSIGSETMASK();
         break;
