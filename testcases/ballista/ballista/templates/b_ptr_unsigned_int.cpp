/*
   b_ptr_unsigned_int.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_ptr_unsigned_intTYPENAME,CLASS_STRING);
strcpy(_b_ptr_unsigned_intMAXUINT,"b_ptr_unsigned_int_MAXUINT");
}

//--------------------------------------------------------------------
b_param *b_ptr_unsigned_int::b_ptr_unsigned_intMAXUINT()
{
   return &_b_ptr_unsigned_intMAXUINT;
}
...
{
  return &_b_ptr_unsigned_intTYPENAME;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_ptr_unsigned_int_maxuint = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_ptr_unsigned_intMAXUINT)==0)
      b_ptr_unsigned_int_maxuint = 1;
  else
    {
...
if (b_ptr_unsigned_int_maxuint==1)
{
...
case 1:
 switch (position)
   {
      case 1:
         return b_ptr_unsigned_intMAXUINT();
         break;
