/*
   b_waitopt.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_waitoptTYPENAME,CLASS_STRING);
strcpy(_b_waitoptNOHANG,"b_waitopt_NOHANG");
strcpy(_b_waitoptUNTRACED,"b_waitopt_UNTRACED");
strcpy(_b_waitoptBOTH,"b_waitopt_BOTH");
}

//--------------------------------------------------------------------
b_param *b_waitopt::b_waitoptNOHANG()
{
   return &_b_waitoptNOHANG;
}

b_param *b_waitopt::b_waitoptUNTRACED()
{
   return &_b_waitoptUNTRACED;
}

b_param *b_waitopt::b_waitoptBOTH()
{
   return &_b_waitoptBOTH;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_waitopt_nohang = 0;
b_waitopt_untraced = 0;
b_waitopt_both = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_waitoptNOHANG)==0)
      b_waitopt_nohang = 1;
   else if (strcmp(data[dataPTR],_b_waitoptUNTRACED)==0)
      b_waitopt_untraced = 1;
   else if (strcmp(data[dataPTR],_b_waitoptBOTH)==0)
      b_waitopt_both = 1;
  else
    {
...
if (b_waitopt_nohang==1 || b_waitopt_both==1)
{
...
if (b_waitopt_untraced==1 || b_waitopt_both==1)
{
...
case 1:
 switch (position)
   {
      case 1:
         return b_waitoptNOHANG();
         break;
      case 2:
         return b_waitoptUNTRACED();
         break;
      case 3:
         return b_waitoptBOTH();
         break;
