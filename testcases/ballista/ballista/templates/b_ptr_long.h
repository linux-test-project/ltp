/*
   b_ptr_long.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSNAME b_ptr_long
#define CLASS_STRING "b_ptr_long"
...
private:
  ...
  b_param _b_ptr_longTYPENAME;
b_param _b_ptr_longMAXLONG;
int b_ptr_long_maxlong;
b_param _b_ptr_longNEG_MAXLONG;
int b_ptr_long_neg_maxlong;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_ptr_longMAXLONG();
b_param *b_ptr_longNEG_MAXLONG();
  //CLASS CONSTRUCTOR
  CLASSNAME();
