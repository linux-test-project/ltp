/*
   b_int.h   Generated by the Ballista(tm) Project data object compiler
...
#define CLASSNAME b_int
#define CLASS_STRING "b_int"
#define CLASSPARENT b_short
...
private:
  ...
  b_param _b_intTYPENAME;
b_param _b_intMAXINT;
int b_int_maxint;
b_param _b_intNEG_MAXINT;
int b_int_neg_maxint;
b_param _b_intA;
int b_int_a;
