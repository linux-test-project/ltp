/*
   b_int_tc.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_int_tcTYPENAME,CLASS_STRING);
strcpy(_b_int_tcTCIFLUSH,"b_int_tc_TCIFLUSH");
strcpy(_b_int_tcTCSANOW,"b_int_tc_TCSANOW");
}

//--------------------------------------------------------------------
b_param *b_int_tc::b_int_tcTCIFLUSH()
{
   return &_b_int_tcTCIFLUSH;
}

b_param *b_int_tc::b_int_tcTCSANOW()
{
   return &_b_int_tcTCSANOW;
}
...
b_int_tc_tcsanow = 0;
   ...
   dataPTR++;
if (strcmp(data[dataPTR],_b_int_tcTCIFLUSH)==0)
      b_int_tc_tciflush = 1;
   else if (strcmp(data[dataPTR],_b_int_tcTCSANOW)==0)
      b_int_tc_tcsanow = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_int_tcTCIFLUSH();
         break;
      case 2:
         return b_int_tcTCSANOW();
         break;
