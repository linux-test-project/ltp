/*
   b_short.h   Generated by the Ballista(tm) Project data object compiler
...
#include "bTypes.h"
 ...
 #define CLASSTYPE short
#define CLASSNAME b_short
#define CLASS_STRING "b_short"
...
private:
  ...
  b_param _b_shortTYPENAME;
b_param _b_shortNEG_ONE;
int b_short_neg_one;
b_param _b_shortNEG_SIXTYFOUR;
int b_short_neg_sixtyfour;
b_param _b_shortNEG_MAXSHORT;
int b_short_neg_maxshort;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_shortNEG_ONE();
b_param *b_shortNEG_SIXTYFOUR();
b_param *b_shortNEG_MAXSHORT();
  //CLASS CONSTRUCTOR
  CLASSNAME();
