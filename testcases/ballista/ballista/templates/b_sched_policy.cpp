/*
   b_sched_policy.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_sched_policyTYPENAME,CLASS_STRING);
strcpy(_b_sched_policyFIFO,"b_sched_policy_FIFO");
strcpy(_b_sched_policyRR,"b_sched_policy_RR");
strcpy(_b_sched_policyOTHER,"b_sched_policy_OTHER");
}

//--------------------------------------------------------------------
b_param *b_sched_policy::b_sched_policyFIFO()
{
   return &_b_sched_policyFIFO;
}

b_param *b_sched_policy::b_sched_policyRR()
{
   return &_b_sched_policyRR;
}

b_param *b_sched_policy::b_sched_policyOTHER()
{
   return &_b_sched_policyOTHER;
}
...
{
  return &_b_sched_policyTYPENAME;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_sched_policy_fifo = 0;
b_sched_policy_rr = 0;
b_sched_policy_other = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_sched_policyFIFO)==0)
      b_sched_policy_fifo = 1;
   else if (strcmp(data[dataPTR],_b_sched_policyRR)==0)
      b_sched_policy_rr = 1;
   else if (strcmp(data[dataPTR],_b_sched_policyOTHER)==0)
      b_sched_policy_other = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_sched_policyFIFO();
         break;
      case 2:
         return b_sched_policyRR();
         break;
      case 3:
         return b_sched_policyOTHER();
         break;
