/*
   b_int_category.h   Generated by the Ballista(tm) Project data object compiler
...
//include control
#ifndef B_INT_CATEGORY_H
#define B_INT_CATEGORY_H
#include <errno.h>
#include <iostream.h>
#include <stdio.h>
#include <stdlib.h>
...
#define CLASSNAME b_int_category
#define CLASS_STRING "b_int_category"
...
private:
  ...
  b_param _b_int_categoryTYPENAME;
b_param _b_int_categoryLC_ALL;
int b_int_category_lc_all;
b_param _b_int_categoryLC_NUMERIC;
int b_int_category_lc_numeric;
  //TYPE VARIABLE TO SAVE VALUE FOR DESTRUCTION
  CLASSTYPE _theVariable;

 public:
  //CLASS DIAL SETTING STRING ACCESS METHODS
b_param *b_int_categoryLC_ALL();
b_param *b_int_categoryLC_NUMERIC();
  //CLASS CONSTRUCTOR
  CLASSNAME();
