/*
   b_mq_attr.h   Generated by the Ballista(tm) Project data object compiler
...
#include "bTypes.h"
 ...
 #include <mqueue.h>
 #include <fcntl.h>
 #define CLASSTYPE mq_attr*
#define CLASSNAME b_mq_attr
#define CLASS_STRING "b_mq_attr"
...
private:
  ...
  b_param _b_mq_attrTYPENAME;
b_param _b_mq_attrQUEUE;
int b_mq_attr_queue;
b_param _b_mq_attrZERO;
int b_mq_attr_zero;
b_param _b_mq_attrNONBLOCK;
int b_mq_attr_nonblock;
b_param _b_mq_attrMAX;
int b_mq_attr_max;
b_param _b_mq_attrMIN;
int b_mq_attr_min;
...
b_param *b_mq_attrQUEUE();
b_param *b_mq_attrZERO();
b_param *b_mq_attrNONBLOCK();
b_param *b_mq_attrMAX();
b_param *b_mq_attrMIN();
  //CLASS CONSTRUCTOR
  CLASSNAME();
