/*
   b_int.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_intTYPENAME,CLASS_STRING);
strcpy(_b_intMAXINT,"b_int_MAXINT");
strcpy(_b_intNEG_MAXINT,"b_int_NEG_MAXINT");
strcpy(_b_intA,"b_int_A");
}

//--------------------------------------------------------------------
b_param *b_int::b_intMAXINT()
{
   return &_b_intMAXINT;
}

b_param *b_int::b_intNEG_MAXINT()
{
   return &_b_intNEG_MAXINT;
}

b_param *b_int::b_intA()
{
   return &_b_intA;
}
...
b_int_a = 0;
   ...
   dataPTR++;
if (strcmp(data[dataPTR],_b_intMAXINT)==0)
      b_int_maxint = 1;
   else if (strcmp(data[dataPTR],_b_intNEG_MAXINT)==0)
      b_int_neg_maxint = 1;
   else if (strcmp(data[dataPTR],_b_intA)==0)
      b_int_a = 1;
  else
    {
