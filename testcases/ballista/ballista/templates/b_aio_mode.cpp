/*
   b_aio_mode.cpp   Generated by the Ballista(tm) Project data object compiler
...
CLASSNAME::CLASSNAME()
{
  ...
  //generated
   ...
   strcpy(_b_aio_modeTYPENAME,CLASS_STRING);
strcpy(_b_aio_modeLIO_WAIT,"b_aio_mode_LIO_WAIT");
strcpy(_b_aio_modeLIO_NOWAIT,"b_aio_mode_LIO_NOWAIT");
}

//--------------------------------------------------------------------
b_param *b_aio_mode::b_aio_modeLIO_WAIT()
{
   return &_b_aio_modeLIO_WAIT;
}

b_param *b_aio_mode::b_aio_modeLIO_NOWAIT()
{
   return &_b_aio_modeLIO_NOWAIT;
}
  ...
  void *CLASSNAME::access(b_param data[])
{
  ...
  //ACCESS CODE
b_aio_mode_lio_wait = 0;
b_aio_mode_lio_nowait = 0;
   int dataPTR =0;


   dataPTR++;
if (strcmp(data[dataPTR],_b_aio_modeLIO_WAIT)==0)
      b_aio_mode_lio_wait = 1;
   else if (strcmp(data[dataPTR],_b_aio_modeLIO_NOWAIT)==0)
      b_aio_mode_lio_nowait = 1;
  else
    {
...
case 1:
 switch (position)
   {
      case 1:
         return b_aio_modeLIO_WAIT();
         break;
      case 2:
         return b_aio_modeLIO_NOWAIT();
         break;
