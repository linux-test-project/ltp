 ...
 *	issue the system call using a bad dirp address
...
int exp_enos[] = {EFAULT, 0};	/* 0 terminated list of expected errnos */
...
main(int ac, char **av)
{
	...
	size_t size = 0;
	char *dir_name = NULL;
	struct dirent *dirp = (struct dirent *)-1; /* set to illegal address */
	...
	for (lc = 0; TEST_LOOPING(lc); lc++) {
		...
		/*
		 * Hopefully we get an error due to the bad dirp address.
		 */
