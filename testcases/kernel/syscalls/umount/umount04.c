...
/******************************************************************************
 * 
 *    TEST IDENTIFIER	: umount04
 * 
 *    EXECUTED BY	: root / superuser
 * 
 *    TEST TITLE	: Test for checking EACCES
 * 
 *    TEST CASE TOTAL	: 1
 * 
 ...
 *
 *    DESCRIPTION
 *	Verify that umount(2) returns -1 and sets errno to  EACCES if the
 *	component of a path was not searchable.
 *	
 * 	Setup:
 ...
 *	  Execute system call
 *	  Check return code, if system call failed and errno == EACCES 
 ...
 *  umount04 [-T type] -D device [-e] [-i n] [-I x] [-p x] [-t]
...
char	*TCID = "umount04";		/* Test program identifier.    */
...
} testcases = { "Component of a path was not searchable.", EACCES, "EACCES"};
...
static option_t options[] = {		/* options supported by umount04 test */
