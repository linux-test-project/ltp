 ...
 *
 * DESCRIPTION
 *	hugeshmget04 - test for EACCES error
 *
 * ALGORITHM
 ...
 *  hugeshmget04 [-c n] [-e] [-i n] [-I x] [-P x] [-t]
...
setup(void)
{
	...
	/* create a large shared memory segment without read or access permissions */
	if ((shm_id_1 = shmget(shmkey, HUGE_SHM_SIZE, IPC_CREAT | IPC_EXCL | SHM_HUGETLB )) == -1) {
