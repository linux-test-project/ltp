...
*
*
* $Id: sfunc.c,v 1.1 2002/02/19 21:29:26 robbiew Exp $
* $Log: sfunc.c,v $
...
#define FORMAT	"| %lu | %s | %d | %s | %s | %s"
	...
	sprintf(cpTheMsg, FORMAT, my_time, levelStr, my_pid, appname, devname, Msg);
