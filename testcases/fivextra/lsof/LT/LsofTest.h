...
/* 
 * 2003-06-18	RCP (RC Paulsen, <rpaulsen@us.ibm.com>)
 * 		changed default path of lsof
 */
...
/*
 * $Id: LsofTest.h,v 1.1 2005/03/22 17:51:30 mridge Exp $
 */
...
#define	LT_DEF_LSOF_PATH	"/usr/bin/lsof"	/* RCP changed from "../lsof" */
