...
/*
 * fivdelete.c             simple http client
...
/* to construct *req.
 *      First %s will be host to delete from
 *      Second %s filename to delete
 */
char    *reqf="DELETE http://%s/%s \r\n\r\n";
...
usage()
{
        ...
        fprintf(stderr,"where:\tfilename is the file to delete.\n");
...
setup(int argc, char **argv)
{
        ...
        req=(char*)malloc(1+strlen(reqf)+strlen(argv[1])+strlen(argv[2]));
        sprintf(req,reqf,argv[1],argv[2]);
