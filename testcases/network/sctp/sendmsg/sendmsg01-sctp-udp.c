...
char *TCID="sendmsg01-sctp-udp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_SEQPACKET, 132, iov, 1, (void *)buf, sizeof(buf), &msgdat, 0,
		(struct sockaddr *)&sin1, sizeof(sin1),
		-1, EBADF, setup0, cleanup0, "bad file descriptor" },
	{ 0, 0, 132, iov, 1, (void *)buf, sizeof(buf), &msgdat, 0,
		(struct sockaddr *)&sin1, sizeof(sin1),
		-1, ENOTSOCK, setup0, cleanup0, "invalid socket" },
	{ PF_INET, SOCK_SEQPACKET, 132, iov, 1, (void *)-1, sizeof(buf), &msgdat, 0,
		(struct sockaddr *)&sin1, sizeof(sin1),
		-1, EFAULT, setup1, cleanup1, "invalid send buffer" },
	{ PF_INET, SOCK_SEQPACKET, 132, iov, 1, (void *)buf, sizeof(buf), &msgdat, 0,
		(struct sockaddr *)&sin2, sizeof(sin2),
		0, EFAULT, setup5, cleanup1, "connected UDP-style" },
	{ PF_INET, SOCK_SEQPACKET, 132, iov, 1, (void *)buf, sizeof(buf), &msgdat, 0,
	...
	{ PF_INET, SOCK_SEQPACKET, 132, 0, 1, (void *)buf, sizeof(buf), &msgdat, 0,
		(struct sockaddr *)&sin1, sizeof(sin1),
		-1, EFAULT, setup1, cleanup1, "invalid iovec pointer" },
	{ PF_INET, SOCK_SEQPACKET, 132, iov, -1, (void *)buf, sizeof(buf), &msgdat,
		0, (struct sockaddr *)&sin1, sizeof(sin1),
		-1, EINVAL, setup1, cleanup1, "invalid iovec count" },
	{ PF_INET, SOCK_SEQPACKET, 132, iov, 1, (void *)buf, sizeof(buf), 0,
		0, (struct sockaddr *)&sin1, sizeof(sin1),
