...
char *TCID="sendmsg01-sctp-tcp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_DGRAM, 132, iov, 1, (void *)buf, sizeof(buf), &msgdat, 0,
		(struct sockaddr *)-1, -1,
	...
	{ PF_INET, SOCK_STREAM, 132, iov, -1, (void *)buf, sizeof(buf), &msgdat,
		0, (struct sockaddr *)&sin1, sizeof(sin1),
		-1, EINVAL, setup1, cleanup1, "invalid iovec count" },
	{ PF_INET, SOCK_STREAM, 132, iov, 1, (void *)buf, sizeof(buf), 0,
		0, (struct sockaddr *)&sin1, sizeof(sin1),
