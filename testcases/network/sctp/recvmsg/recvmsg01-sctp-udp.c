...
char *TCID="recvmsg01-sctp-udp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_SEQPACKET, 132, iov, 1, buf, sizeof(buf), &msgdat, 0,
	...
	{ PF_INET, SOCK_SEQPACKET, 132, iov, 1, (void *)buf, sizeof(buf), &msgdat,-1,
		(struct sockaddr *)&from, sizeof(from),
