...
char *TCID="recvmsg01-sctp-tcp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_STREAM, 132, iov, 1, buf, sizeof(buf), &msgdat, 0,
	...
	{ PF_INET, SOCK_STREAM, 132, iov, 1, (void *)buf, sizeof(buf), &msgdat, 0,
	...
	{ PF_INET, SOCK_STREAM, 132, iov, 1, (void *)-1, sizeof(buf), &msgdat, 0,
		(struct sockaddr *)&from, sizeof(from),
		-1, EFAULT, setup1, cleanup1, "invalid recv buffer" },
	{ PF_INET, SOCK_STREAM, 132, 0, 1, (void *)buf, sizeof(buf), &msgdat, 0,
		(struct sockaddr *)&from, sizeof(from),
		-1, EFAULT, setup1, cleanup1, "invalid iovec buffer" },
	{ PF_INET, SOCK_STREAM, 132, iov, -1, (void *)buf, sizeof(buf), &msgdat,0,
		(struct sockaddr *)&from, sizeof(from),
		-1, EINVAL, setup1, cleanup1, "invalid iovec count" },
	{ PF_INET, SOCK_STREAM, 132, iov, 1, (void *)buf, sizeof(buf), &msgdat,-1,
		(struct sockaddr *)&from, sizeof(from),
