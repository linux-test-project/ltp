...
char *TCID="bind01-sctp-tcp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)-1,
		sizeof(struct sockaddr_in), -1, EFAULT, setup0, cleanup0,
		"invalid sockaddr for UDP style SCTP" },
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)&sin1,
	...
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)&sin2,
		sizeof(sin2), 0, 0, setup0, cleanup0,
		"INADDR_ANYPORT for UDP style SCTP" },
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)&sin3,
