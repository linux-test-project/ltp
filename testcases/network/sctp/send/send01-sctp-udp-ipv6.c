 ...
 *  send02-sctp-udp [-c n] [-i n] [-I x] [-p x] [-t]
 ...
 *
 * HISTORY
 *	05/2002 Adapted for SCTP IPv6 Mingqin Liu
 *
 * RESTRICTIONS:
 *  None.
 *
...
char *TCID="send02-sctp-udp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET6, SOCK_SEQPACKET, IPPROTO_SCTP, (void *)-1, sizeof(buf), 0,
        ...
        { PF_INET6, SOCK_SEQPACKET, IPPROTO_SCTP, buf, sizeof(buf), 
	       MSG_DONTWAIT, -1, 22, setup1, cleanup1, "MSG_DONTWAIT flag" },
        { PF_INET6, SOCK_SEQPACKET, IPPROTO_SCTP, buf, sizeof(buf), 
	       MSG_NOSIGNAL, -1, 22, setup1, cleanup1, "MSG_NOSIGNAL flag" },
        { PF_INET6, SOCK_SEQPACKET, IPPROTO_SCTP, buf, sizeof(buf), 
	       0, -1, 22, setup1, cleanup1, "a regular send " },
};
