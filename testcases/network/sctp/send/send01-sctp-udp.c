 ...
 *  send01-sctp-udp [-c n] [-e] [-i n] [-I x] [-p x] [-t]
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_SEQPACKET, 0, (void *)-1, sizeof(buf), 0,
                -1, EFAULT, setup1, cleanup1, "invalid send buffer" },
	{ PF_INET, SOCK_SEQPACKET, 132, bigbuf, sizeof(bigbuf), 0,
		-1, EMSGSIZE, setup1, cleanup1, "message too big" },
        { PF_INET, SOCK_SEQPACKET, 132, -1, sizeof(buf), -1,
