 ...
 *  connect01-sctp-udp [-c n] [-i n] [-I x] [-P x] [-t]
...
char *TCID="connect01-sctp-udp";	/* Test program identifier.    */
int testno;
...
setup(void)
{
	...
	sin3.sin_family = 47;	/* bogus address family */
	sin3.sin_port = 0;
