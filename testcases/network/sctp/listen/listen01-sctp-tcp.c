...
char *TCID="listen01-sctp-tcp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ 0, 0, 132, 0, -1, EBADF, setup0, cleanup0,
                "bad file descriptor" },
        { 0, 0, 132, 0, -1, ENOTSOCK, setup0, cleanup0,
                "not a socket" },

	{ PF_INET, SOCK_STREAM, 132, 0, 0, 0, setup1, cleanup1,
		"TCP-style listen" },
};
