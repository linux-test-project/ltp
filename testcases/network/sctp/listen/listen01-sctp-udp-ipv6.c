 ...
 *  listen04-sctp-udp [-c n] [-i n] [-I x] [-P x] [-t]
...
char *TCID="listen04-sctp-udp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ 0, 0, IPPROTO_SCTP, 0, -1, ENOTSOCK, setup0, cleanup0,
		"not a socket" },
	{ PF_INET6, SOCK_SEQPACKET, IPPROTO_SCTP, 0, 0, 0, setup1, cleanup1,
		"UDP-style listen: backlog = 0" },
	{ PF_INET6, SOCK_SEQPACKET, IPPROTO_SCTP, -1, 0, 0, setup1, cleanup1,
		"backlog = -1" },
	{ PF_INET6, SOCK_SEQPACKET, IPPROTO_SCTP, 1, 0, 0, setup1, cleanup1,
		"backlog = 1" },
	{ PF_INET6, SOCK_SEQPACKET, IPPROTO_SCTP, 5, 0, 0, setup1, cleanup1,
...
setup1(void)
{
	...
	/* To avoid IPv6 autobind fault for now. */	
        v6.sin6_family = AF_INET6;
        v6.sin6_port = 0;
        v6.sin6_addr = (struct in6_addr) IN6ADDR_ANY_INIT;

        if (bind(s, (struct sockaddr *)&v6, sizeof(v6)) < 0) {
