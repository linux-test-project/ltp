 ...
 *  recv01-sctp-udp [-c n] [-i n] [-I x] [-P x] [-t]
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_SEQPACKET, IPPROTO_SCTP, buf, sizeof(buf), MSG_PEEK,
		0, 0, setup1, cleanup1, "MSG_PEEK flag" },
	{ PF_INET, SOCK_SEQPACKET, IPPROTO_SCTP, buf, sizeof(buf), MSG_WAITALL,
