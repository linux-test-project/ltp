...
char *TCID="recv01-sctp-udp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_SEQPACKET, 132, buf, sizeof(buf), 0,
		-1, EBADF, setup0, cleanup0, "bad file descriptor" },
	{ 0, 0, 132, buf, sizeof(buf), 0,
		-1, ENOTSOCK, setup0, cleanup0, "invalid socket" },
	{ PF_INET, SOCK_SEQPACKET, 132, (void *)-1, sizeof(buf), 0,
		-1, EFAULT, setup1, cleanup1, "invalid recv buffer" },
	{ PF_INET, SOCK_SEQPACKET, 132, buf, sizeof(buf), -1,
