...
char *TCID="setsockopt01-sctp-tcp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_STREAM, 132, SOL_SOCKET, SO_OOBINLINE, &optval,
	...
	{ PF_INET, SOCK_STREAM, 132, SOL_SOCKET, SO_OOBINLINE, 0,
		sizeof(optval), (struct sockaddr *)&fsin1, sizeof(fsin1), -1,
		EFAULT, setup1, cleanup1, "invalid option buffer" },
	{ PF_INET, SOCK_STREAM, 132, SOL_SOCKET, SO_OOBINLINE, &optval, 0,
		(struct sockaddr *)&fsin1, sizeof(fsin1), -1,
		EINVAL, setup1, cleanup1, "invalid optlen" },
	{ PF_INET, SOCK_STREAM, 132, 500, SO_OOBINLINE, &optval, sizeof(optval),
		(struct sockaddr *)&fsin1, sizeof(fsin1), -1,
