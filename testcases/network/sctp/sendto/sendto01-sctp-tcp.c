...
char *TCID="sendto01-sctp-tcp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	{ PF_INET, SOCK_STREAM, 132, buf, sizeof(buf), 0, &sin1, sizeof(sin1),
	...
	{ PF_INET, SOCK_STREAM, 132, (void *)-1, sizeof(buf), 0, &sin1,
		sizeof(sin1),
		-1, EFAULT, setup1, cleanup1, "invalid send buffer" },
	{ PF_INET, SOCK_STREAM, 132, buf, sizeof(buf), 0, &sin2, sizeof(sin2),
		 0, EFAULT, setup1, cleanup1, "connected" },
	{ PF_INET, SOCK_STREAM, 132, buf, sizeof(buf), 0, &sin1, sizeof(sin1),
		-1, EPIPE, setup3, cleanup1, "not connected" },
	{ PF_INET, SOCK_STREAM, 132, buf, sizeof(buf), 0, &sin1, -1,
		-1, EINVAL, setup1, cleanup1, "invalid to buffer length" },
	{ PF_INET, SOCK_STREAM, 132, buf, sizeof(buf), 0, (struct sockaddr_in *)-1,
		sizeof(sin1),
		-1, EFAULT, setup1, cleanup1, "invalid to buffer" },
	{ PF_INET, SOCK_STREAM, 132, buf, sizeof(buf), 0, &sin1, sizeof(sin1),
		-1, EPIPE, setup2, cleanup1, "local endpoint shutdown" },
	{ PF_INET, SOCK_STREAM, 132, buf, sizeof(buf), -1, &sin1, sizeof(sin1),
