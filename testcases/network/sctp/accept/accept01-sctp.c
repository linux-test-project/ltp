...
/*
 * Test Name: accept01-sctp
 *
 * Test Description:
 *  Verify that accept() returns the proper errno for various failure cases
 *
 * Usage:  <for command-line>
 *  accept01-sctp [-c n] [-e] [-f] [-i n] [-I x] [-P x] [-t]
...
char *TCID="accept01-sctp";		/* Test program identifier.    */
int testno;
...
struct test_case_t {		/* test case structure */
	...
	int	*salen;	/* accept's 3rd argument */
	...
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)&fsin1,
		&sinlen, -1, EBADF, setup0, cleanup0,
		"bad file descriptor" },
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)&fsin1,
		&sinlen, -1, ENOTSOCK, setup0, cleanup0,
		"bad file descriptor" },
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)3,
		&sinlen, -1, EINVAL, setup1, cleanup1,
		"invalid socket buffer" },
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)&fsin1,
		(int *)1, -1, EINVAL, setup1, cleanup1,
		"invalid salen" },
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)&fsin1,
	...
	{ PF_INET, SOCK_STREAM, 132, (struct sockaddr *)&fsin1,
	 ...
	 { PF_INET, SOCK_SEQPACKET, 132, (struct sockaddr *)&fsin1,
