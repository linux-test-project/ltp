 ...
 * assertion:
 *
 *	The function will compare the string pointed to by s1 to the string
 *	pointed to by s2. Upon completion, function will return an integer
 *	greater than 0, if the string pointed to by s1 is greater
